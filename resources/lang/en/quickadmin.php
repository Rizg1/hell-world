...
return [
	...
	'clients' => [
		...
		'fields' => [
			'name' => 'Company Name',
			'app_form' => 'Application for HMO',
			'kyc_form' => 'KYC Form',
			'enrollment_list' => 'Member Enrollment List',
			'sec_reg' => 'Signed Proposal',
			'sec_articles' => 'Sec Registration',
			'articles_incorp' => 'Articles of Incorporation',
			'by_laws' => 'Copies of By-Laws',
			'corp_sec' => 'COC',
			'cert_list' => 'Certified List',
